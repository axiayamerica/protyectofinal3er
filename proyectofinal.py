#proyectofinal 
#submodulo
#Autores: america garcia y axia sifuentes 
...
def abrir_acerca_de():
    ...
    lbl_creado = tk.Label(acerca,
        text="Creado por: america segura y axia sifuentes",
        font=("Arial", 12)
    )
...
# ---------------------------------------------------------
ventana = tk.Tk()
ventana.title("Punto de Ventas - Boutique")
ventana.geometry("500x600")
ventana.configure(bg="#44505c")
...
estilo = ttk.Style()
estilo.configure("TButton", font=("Arial", 12), padding=10, background="#2d89ef")
estilo.map("TButton", background=[("active", "#1e5fab")])
